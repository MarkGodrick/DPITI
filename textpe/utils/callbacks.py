...
class _ComputeFID(Callback):
    ...
    def __init__(self, priv_data, embedding, filter_criterion=None, fid_sample_num = 20000):
        """Constructor.

        :param priv_data: The embeddings of private data
        :type priv_data: np.ndarray
        :param embedding: The embedding to compute the FID of synthetic data
